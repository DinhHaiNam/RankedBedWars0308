...
package com.tomkeuper.bedwars.support.version.v1_20_6;
...
import com.tomkeuper.bedwars.support.version.v1_20_6.despawnable.DespawnableAttributes;
import com.tomkeuper.bedwars.support.version.v1_20_6.despawnable.DespawnableFactory;
import com.tomkeuper.bedwars.support.version.v1_20_6.despawnable.DespawnableType;
import com.tomkeuper.bedwars.support.version.v1_20_6.hologram.HoloLine;
...
public final class v1_20_6 extends VersionSupport {

    private final DespawnableFactory despawnableFactory;

    public v1_20_6(Plugin plugin, String name) {
        super(plugin, name);
        loadDefaultEffects();
    ...
    public boolean isInvisibilityPotion(org.bukkit.inventory.@NotNull ItemStack itemStack) {
        if (!itemStack.getType().equals(Material.POTION)) return false;
    ...
    public void spawnShopHologram(Location loc, String name1, Iterable<Player> players, IArena arena) {
    ...
    public org.bukkit.inventory.ItemStack createItemStack(String material, int amount, short data) {
        ...
        try {
            i = new org.bukkit.inventory.ItemStack(Material.valueOf(material), amount);
        } catch (Exception ex) {
            getPlugin().getLogger().log(Level.WARNING, material + " is not a valid " + getName() + " material!");
            i = new org.bukkit.inventory.ItemStack(Material.BEDROCK);
        }
        return i;
    }
    ...
    @Override
    public Material materialEndStone() {
